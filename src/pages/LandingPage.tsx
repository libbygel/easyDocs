...
const features = [
  ...
  {
    icon: Send,
    title: "שליחה לבנקאי בקליק",
    desc: "בחר מסמכים, בחר בנקאי מרשימת אנשי הקשר – והכל נשלח במייל מסודר.",
    highlight: true,
  },
  {
...
const testimonials = [
  { name: "אורי כ.", role: "יועץ משכנתאות", text: "מאז שאני משתמש ב-EasyDocs אני חוסך לפחות שעתיים ביום. הלקוחות פשוט מעלים הכל לבד." },
  { name: "מיכל ד.", role: "יועצת משכנתאות", text: "החתימות הדיגיטליות חסכו לי את הריצה ללקוחות. הכל נגמר אונליין." },
  { name: "יוסי ש.", role: "יועץ בכיר", text: "הבנקאים מקבלים מייל מסודר עם כל המסמכים. זה שינה לי את הפנים מול הבנקים." },
];
