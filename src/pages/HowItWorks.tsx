...
const features = [
  ...
  },
  {
    icon: ListChecks,
    title: 'ניהול משימות',
    desc: 'משימות אישיות וכלליות, משימות פר תיק, עם תאריך יעד, עדיפות ותזכורות אוטומטיות במייל ובמערכת.',
  },
  {
    icon: MessageSquare,
    title: 'סיכומי שיחות עם לקוחות',
    desc: 'תעדו כל שיחה טלפונית או פגישה עם הלקוח — תאריך, נושא ותוכן — וכל ההיסטוריה נשארת מסודרת בכרטיס הלקוח.',
  },
  {
    icon: Bell,
    title: 'התראות בזמן אמת',
    desc: 'קבלו עדכונים מיידיים בתוך המערכת ובמייל על כל פעולה — העלאת מסמך, חתימה, אישור או שליחה.',
  },
  {
    icon: Briefcase,
    title: 'אנשי קשר מקצועיים',
    desc: 'נהלו רשימת בנקאים, רואי חשבון ועורכי דין — ושלחו אליהם תיקים מלאים בלחיצה.',
  },
  {
    icon: Send,
    title: 'שליחה ישירה לבנקאי / רו"ח',
    desc: 'שלחו את כל מסמכי התיק במייל מוצפן ישירות לאיש הקשר המקצועי, עם הודעה מותאמת.',
  },
  {
    icon: UserPlus,
  ...
  {
    icon: Mail,
    title: 'מייל קבוצתי ללקוחות',
    desc: 'שלחו הודעה אחת לקבוצת לקוחות — לעדכונים, מבצעים, או תזכורות עונתיות.',
  },
  {
    icon: Copy,
  ...
  },
  {
    icon: RefreshCw,
    title: 'חיובים חוזרים',
    desc: 'הגדירו חיוב חודשי או שנתי קבוע לכל לקוח, והמערכת תיצור אותם אוטומטית במועד.',
  },
  {
    icon: FileSignature,
    title: 'העלאה ע"י היועץ',
    desc: 'גם אתם יכולים להעלות מסמכים בשם הלקוח — סריקות, מסמכים שהתקבלו במייל, וכו׳.',
  },
  {
    icon: GripVertical,
  ...
  },
  {
    ...
    desc: 'ציר זמן מפורט לכל תיק — מי עשה מה ומתי, מתאים לביקורת ולמעקב מקצועי.',
  },
  {
    icon: BarChart3,
    title: 'דוחות וייצוא לאקסל/PDF',
    desc: 'דוח שעות חודשי, דוח פעילות, ייצוא רשימות לקוחות ותיקים — הכל בעברית עם תמיכת RTL.',
  },
  {
    icon: Archive,
    title: 'הורדה מרוכזת ב-ZIP',
    desc: 'הורידו את כל מסמכי התיק המאושרים בקובץ ZIP אחד — מוכן להעברה לרו"ח או לבנק.',
  },
  {
    icon: FolderTree,
    title: 'קטגוריות וסיווג מסמכים',
    desc: 'ארגנו מסמכים לקטגוריות (הכנסות, הוצאות, אישורים וכו׳) לתצוגה ברורה ונוחה.',
  },
];
