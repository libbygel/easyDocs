...
const steps = [
  ...
  },
  {
    ...
    icon: FileText,
    title: 'יצירת תבניות',
    desc: 'הגדירו סוגי תיק (כמו "משכנתא חדשה", "מחזור"). לכל סוג תיק הגדירו רשימת מסמכים נדרשים — תלוש שכר, צילום ת.ז, אישור יתרה וכו׳.',
  ...
  },
  {
    num: '7',
    icon: CheckCircle2,
    title: 'סיום והפקת דו״ח',
    desc: 'כשכל המסמכים אושרו — סמנו את התיק כהושלם, הורידו את כל הקבצים בלחיצה, או שלחו ישירות לבנקאי.',
