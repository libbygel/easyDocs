...
const caseTypes = [
  { name: "דוח שנתי – שכיר", docs: ["טופס 106", "אישורי ניכוי מס", "תעודת זהות", "אישור הפקדות לפנסיה"], color: "#f59e0b" },
  { name: "דוח שנתי – עצמאי", docs: ["דוח רווח והפסד", "ספרי הנהלת חשבונות", "אישורי הוצאות", "תעודת זהות"], color: "#3b82f6" },
  { name: "פתיחת תיק במס הכנסה", docs: ["תעודת זהות", "אישור ניהול חשבון בנק", "טופס 5329", "אישור עוסק"], color: "#10b981" },
  { name: "החזר מס", docs: ["טופס 106 (3 שנים)", "אישורי תרומות", "אישור הפקדות לקופ״ג", "תעודת זהות"], color: "#8b5cf6" },
];
